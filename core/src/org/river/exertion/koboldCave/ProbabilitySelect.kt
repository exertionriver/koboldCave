package org.river.exertion.koboldCave
...
class ProbabilitySelect<T>(val probabilities : Map<T, Probability>) {
    ...
    override fun toString() = "org.river.exertion.koboldCave.ProbabilitySelect(${totalPossibility}, ${selectedProbability}) : ${getSelectedProbability()}"
