...
object ApproachFocus : IInternalFocus {
    ...
    override fun satisfyingResult(entity: Telegraph, targetSymbol : SymbolInstance) {
        MessageManager.getInstance().dispatchMessage(entity, MessageChannel.INT_SYMBOL_MODIFY.id(), SymbolMessage().apply { this.targetSymbolInstance = targetSymbol.apply { this.deltaPosition = -0.05f }})
    }
}