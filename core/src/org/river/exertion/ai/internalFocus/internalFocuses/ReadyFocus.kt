...
object ReadyFocus : IInternalFocus {
    ...
    override fun satisfyingResult(entity: Telegraph, targetSymbol : SymbolInstance) {
        ...
        MessageManager.getInstance().dispatchMessage(entity, MessageChannel.INT_SYMBOL_MODIFY.id(), SymbolMessage(targetSymbolInstance = targetSymbol.apply { this.deltaPosition = -deltaPosition}) )
    }
}